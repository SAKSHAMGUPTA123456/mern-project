...
export const Allcontact=()=>{
    ...
    const response = await fetch('https://mern-project-tv78.onrender.com/admin/contact', {
      method: "GET",
      headers: {
...
getallcontactdata()
    ...
    const handlingdelete=async(id)=>{
        const response=await fetch(`https://mern-project-tv78.onrender.com/admin/contact/delete/${id}`,{
            method:"DELETE",
            headers:{
                Authorization:`Bearer ${oldtoken}`
            }
