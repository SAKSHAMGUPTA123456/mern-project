...
const {oldtoken}=Useauth()
  const getuserdata = async () => {
    const response = await fetch("https://mern-project-tv78.onrender.com/admin/user", {
      method: "GET",
      headers: {
...
const handledelete=async(value)=>{
  console.log(olddata)
const response=await fetch(`https://mern-project-tv78.onrender.com/admin/user/${value}`,{
  method:"DELETE",
  headers:{
